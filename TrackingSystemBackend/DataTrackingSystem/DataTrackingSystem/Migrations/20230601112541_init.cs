        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InvitedPersonStatus = table.Column<int>(type: "int", nullable: false),
                    InvitedPersonAction = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Invitations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Invitations_AspNetUsers_InvitationReceiverUserId",
                        column: x => x.InvitationReceiverUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_Invitations_AspNetUsers_InvitationSenderUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserOperation = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Tracking_Shipping_ShippingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Invitations_InvitationReceiverUserId",
                table: "Invitations",
                column: "InvitationReceiverUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Invitations_InvitationSenderUserId",
                table: "Invitations",
